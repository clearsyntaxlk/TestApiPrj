...
; (function (global, factory) {
    ...
    var jexcel = (function (el, options) {
        ...
        */
        ...
        obj.setValueFromCoordsOnly4Error = function (x, y, value, force) {
            var records = [];
            records.push(obj.updateCell(x, y, value, force));
        ...
        obj.updateTable = function () {
            ...
            if (typeof (obj.options.updateTable) == 'function') {
                ...
                //-- mdf done by cpk 20-09-2024
                for (var j = 0; j < obj.rows.length; j++) {
                    for (var i = 0; i < obj.headers.length; i++) {
                        try {
                            if (obj.records[j][i].innerText.trim() != "") {
                ...
                /*commented by cpk for (var j = 0; j < obj.rows.length; j++) {
                    for (var i = 0; i < obj.headers.length; i++) {
                        obj.options.updateTable(el, obj.records[j][i], i, j, obj.options.data[j][i], obj.records[j][i].innerText, jexcel.getColumnNameFromId([i, j]));
                    }
                }*/
